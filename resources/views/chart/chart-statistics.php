        ...
        <div class="bottom">
    		<div class="col-sm-2">
    			<div class="menu">
    	            <ul class="nav nav-tabs nav-stacked" data-spy="affix" data-offset-top="600">
    	                ...
    	                <li class="active"><a href="/statistics" >收支统计</a></li>
    	    ...
    	    <div class="main col-sm-10 ">
				...
				<div class="col-sm-10" id="main-chart">
					...
					<div class="col-sm-2" id="expend-bar-chart" style="width: 800px;height:400px;"></div>
					<div class="col-sm-2" id="income-bar-chart" style="width: 800px;height:400px;"></div>
				</div>    		    
    		</div>    
